"""
OpenQA QLoRA fine-tuning + evaluation for LLaMA-3.1-8B-Instruct.
...
class CFG:
    ...
    output_dir: str = "sft_llama3p1_8b_openqa_qlora"
...
def main():
    ...
    result_path = "openqa_finetune_results_llama3p1_8b.txt"
