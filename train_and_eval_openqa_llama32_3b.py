"""
OpenQA QLoRA fine-tuning + evaluation for LLaMA-3.2-3B-Instruct.
...
class CFG:
    ...
    output_dir: str = "sft_llama3p2_3b_openqa_qlora"
...
def main():
    ...
    result_path = "openqa_finetune_results_llama3p2_3b.txt"
