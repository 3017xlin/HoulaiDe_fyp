"""
Base model (no fine-tuning) → Open QA evaluation for Phi-3.5-mini-Instruct.
...
OUTPUT_FILE = "base_openqa_results_phi3p5_mini.txt"
MAX_NEW_TOKENS = 64
...
def main():
    ...
    log("Loading base model (no adapter, full precision)...")
    ...
    log("=" * 80)
    log("[BASE MODEL — Phi-3.5-mini → Open QA]")
