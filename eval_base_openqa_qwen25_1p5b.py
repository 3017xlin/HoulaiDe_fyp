"""
Base model (no fine-tuning) → Open QA evaluation for Qwen2.5-1.5B-Instruct.
...
OUTPUT_FILE = "base_openqa_results_qwen25_1p5b.txt"
MAX_NEW_TOKENS = 64
...
def main():
    ...
    log("=" * 80)
    log("[BASE MODEL — Qwen2.5-1.5B → Open QA]")
