"""
OpenQA QLoRA fine-tuning + evaluation for Phi-3.5-mini-Instruct.
...
class CFG:
    ...
    output_dir: str = "sft_phi3p5_mini_openqa_qlora"
    ...
    target_modules: tuple = ("qkv_proj", "o_proj")
...
def main():
    ...
    result_path = "openqa_finetune_results_phi3p5_mini.txt"
