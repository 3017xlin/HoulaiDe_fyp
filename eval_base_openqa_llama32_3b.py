"""
Base model (no fine-tuning) → Open QA evaluation for LLaMA-3.2-3B-Instruct.
...
OUTPUT_FILE = "base_openqa_results_llama3p2_3b.txt"
MAX_NEW_TOKENS = 64
...
def main():
    ...
    log("=" * 80)
    log("[BASE MODEL — LLaMA-3.2-3B → Open QA]")
