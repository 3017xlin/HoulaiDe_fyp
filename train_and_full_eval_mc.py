...
class CFG:
    ...
    output_dir: str = "sft_qwen2p5_1p5b_qlora_safe_resume2"
    ...
    # 训练后评估规模
    train_eval_samples: int = 1000   # 这里默认 1000+
    eval_use_all: bool = True        # eval 全部用上
...
def main():
    ...
    result_path = "mc_train_and_large_eval_results_safe_resume2.txt"
